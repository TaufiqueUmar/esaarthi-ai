...
export default function ComplaintOTP() {
    ...
    const handleVerify = () => {
        ...
        navigate('/complaint-success', {
            state: { service, consumerNo, category, description, mobile, otp: otp.join('') },
        })
    }
        ...
        >
            ...
            <main className="flex-1 flex flex-col overflow-hidden px-16 pt-5 pb-3">
                ...
                <div className="flex-shrink-0 mb-2">
                    <h1 className="font-extrabold text-gray-900 text-4xl">Verify Mobile Number</h1>
                    ...
                    <div className="flex flex-col items-center gap-2 py-2" style={{ width: '560px' }}>
                        ...
                        <button
                            ...
                            className={[
                                ...
                                isComplete
                                    ? 'bg-yellow-300 border-yellow-500 text-gray-900 cursor-pointer active:scale-95'
